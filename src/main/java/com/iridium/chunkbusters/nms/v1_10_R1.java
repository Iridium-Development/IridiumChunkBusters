...
public class v1_10_R1 implements NMS {
    ...
    public void setBlockFast(org.bukkit.World world, int x, int y, int z, int blockId, byte data, boolean applyPhysics) {
        ...
        net.minecraft.server.v1_10_R1.Chunk nmsChunk = nmsWorld.getChunkAt(x >> 4, z >> 4);
        IBlockData ibd = net.minecraft.server.v1_10_R1.Block.getByCombinedId(blockId + (data << 12));
