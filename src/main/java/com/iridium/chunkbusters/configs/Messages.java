...
public class Messages {
    ...
    public String unknownCommand = "%prefix% &7Unknown Command, Try /chunkbusters help";
    public String helpMessage = "&e&l * &7 %command% : &e %description%";
    public String helpHeader = "&e&lIridiumChunkBusters: &eHelp";
    public String helpfooter = "&e<< &7Page %page% of %maxpage% &e>>";
